...
mode "ide" {
    ...
    #IDE (Pycharm)
    bindsym p workspace 3:edit;exec pycharm, mode "default", exec pkill i3-nagbar
    bindsym Shift+p exec pycharm, mode "default", exec pkill i3-nagbar
    
    #IDE (IntelliJ IDEA)
    bindsym i workspace 3:edit;exec idea, mode "default", exec pkill i3-nagbar
    bindsym Shift+i exec idea, mode "default", exec pkill i3-nagbar
    
    #IDE (WebStorm)
    bindsym w workspace 3:edit;exec webstorm, mode "default", exec pkill i3-nagbar
    bindsym Shift+w exec webstorm, mode "default", exec pkill i3-nagbar
...
bindsym $super+i mode "ide" exec "i3-nagbar -t warning -m '(i) IntelliJ IDEA (p) Pycharm (w) WebStorm (e) Emacs'"
```
