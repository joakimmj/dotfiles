...
[
  ...
  },
  {
    ...
    "color": ${if_match "charging" >= "${exec upower -i /org/freedesktop/UPower/devices/battery_BAT0 | grep 'state:' | cut -b26-}"}"\#00ff00"${else}${if_match ${battery_percent}<30}"\#ce8907"${else}"\#828282"${endif}${endif}
  },
  {
  ...
  {
    "full_text": "${if_running spotify}Spotify: ${scroll 15 1 ${exec ~/.config/i3/spotify_info.sh}}${endif}",
    "color": "\#828282"
  },
  {
    "full_text": ""
