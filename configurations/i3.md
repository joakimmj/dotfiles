...
[
  ...
  },
  {
    ...
    "color": ${if_match ${cpu}<90}"\#828282"${else}"\#CE8907"${endif}
  },
  {
    "full_text": "${acpitemp}°C",
    "color": ${if_match ${acpitemp}<90}"\#828282"${else}"\#CE8907"${endif}
  },
  {
    "full_text": "RAM ${memperc}%",
    "color": ${if_match ${memperc}<90}"\#828282"${else}"\#CE8907"${endif}
  },
  {
  ...
  {
    "full_text": "Battery: ${execi 60 acpi -b | awk '{print $4}' | head -c -2}",
    "color": ${if_match ${execi 60 acpi -b | awk '{print $4}' | head -c -3}<=10}"\#CE8907"${else}"\#828282"${endif}
  },
  {
    "full_text": "${exec setxkbmap -query | awk '/layout/{print $2}' | tr 'a-z' 'A-Z'}",
    "color": "\#828282"
  },
  {
    "full_text": ""
