...
### ~/.config/nvim/lua/my/mappings.lua
```lua
vim.g.mapleader = " "
...
vim.keymap.set("n", "<leader>e", function() vim.cmd("25Lex") end)
```
...
### ~/.config/nvim/lua/my/netrw.lua
```lua
vim.g.netrw_bufsettings="noma nomod nu nobl nowrap ro"
```

## Nvim without plugin
init.lua (ref. https://gitlab.com/linuxdabbler/dotfiles/-/blob/main/.config/nvim/init.lua?ref_type=heads)
